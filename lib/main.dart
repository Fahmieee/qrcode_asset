...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      title: 'QR Code System PAR',
      debugShowCheckedModeBanner: false,
      theme: ThemeData(
        primarySwatch: Colors.blue,
      ),
      home: MyHomePage(title: 'CekAja PAR'),
    );
  }
}
...
class DialogEditSiswa extends StatefulWidget {
  ...
  DialogEditSiswa({Key key, this.title, this.rowSiswa, this.action})
      : super(key: key);
...
class _DialogEditSiswaState extends State<DialogEditSiswa> {
  ...
  TextEditingController _txtnoPolisi = TextEditingController();
  TextEditingController _txtnoRangka = TextEditingController();
  TextEditingController _txtnoMesin = TextEditingController();
  TextEditingController _txtketerangan = TextEditingController();
  TextEditingController _txtrefNumberQrCode = TextEditingController();
  ...
  void initState() {
    ...
    if (widget.action == "edit") {
      ...
      _txtnoPolisi.text = widget.rowSiswa["No. Polisi"].toString();
      _txtnoRangka.text = widget.rowSiswa["No. Rangka"].toString();
      _txtnoMesin.text = widget.rowSiswa["No. Mesin"].toString();
      _txtketerangan.text = widget.rowSiswa["Keterangan"].toString();
      _txtrefNumberQrCode.text =
          widget.rowSiswa["Ref. Number QR Code"].toString();
    }
    super.initState();
  }
      ...
      actions: <Widget>[
        FlatButton(
          ...
          onPressed: () {
            ...
            String _noPolisi = _txtnoPolisi.text;
            String _noRangka = _txtnoRangka.text;
            String _noMesin = _txtnoMesin.text;
            String _keterangan = _txtketerangan.text;
            String _refNumberQrCode = _txtrefNumberQrCode.text;
            Map<String, String> mRequest = {
              ...
              "refNumberQrCode": _refNumberQrCode,
            };
            util
...
class _MyHomePageState extends State<MyHomePage> {
  ...
  void _showEditDialog(Map _row) {
    showDialog(
        ...
        builder: (BuildContext context) {
          return DialogEditSiswa(
              rowSiswa: _row, title: "Edit Kendaraan", action: "edit");
        }).then((ret) {
  ...
  void _showNewDialog() {
    showDialog(
        ...
        builder: (BuildContext context) {
          return DialogEditSiswa(
              rowSiswa: null, title: "Tambah Kendaraan", action: "new");
        }).then((ret) {
      //. format kembalian (status#desc)
      if (ret != null && ret.toString().length > 0) {
        List<String> lstRet = ret.toString().split("#");
        ...
        child: Row(
          children: <Widget>[
            ...
            Expanded(
              ...
              child: Container(
                padding: EdgeInsets.symmetric(horizontal: 10, vertical: 5),
                child: Text(_r["noPolisi"].toString()),
              ),
            ),
            Expanded(
              flex: 2,
              child: Container(
                padding: EdgeInsets.symmetric(horizontal: 10, vertical: 5),
                child: Text(_r["noRangka"].toString()),
              ),
            ),
            Expanded(
              flex: 2,
              child: Container(
                padding: EdgeInsets.symmetric(horizontal: 10, vertical: 5),
                child: Text(_r["noMesin"].toString()),
              ),
            ),
            Expanded(
              flex: 2,
              child: Container(
                padding: EdgeInsets.symmetric(horizontal: 10, vertical: 5),
                child: Text(_r["keterangan"].toString()),
              ),
            ),
            Expanded(
              flex: 2,
              child: Container(
                padding: EdgeInsets.symmetric(horizontal: 10, vertical: 5),
                child: Text(_r["refNumberQrCode"].toString()),
              ),
            ),
            Container(
